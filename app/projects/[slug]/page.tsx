...
export function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  return { title: project ? `${project.title} — Tevexxo` : 'Project — Tevexxo' };
}
    ...
    <div className="bg-slate-50">
      <header className="hero-grid relative overflow-hidden pb-16 pt-28">
        <div className="container relative z-10">
          <Link href="/projects" className="mb-4 inline-flex items-center gap-2 text-xs font-bold text-slate-300 hover:text-white">
